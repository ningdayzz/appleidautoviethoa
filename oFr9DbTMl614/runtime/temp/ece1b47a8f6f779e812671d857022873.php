<?php /*a:4:{s:51:"/www/wwwroot/apple.zenpn.com/view/user/account.html";i:1688836561;s:45:"/www/wwwroot/apple.zenpn.com/view/layout.html";i:1683542048;s:50:"/www/wwwroot/apple.zenpn.com/view/user/header.html";i:1688815274;s:50:"/www/wwwroot/apple.zenpn.com/view/user/footer.html";i:1688813568;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
            ...
            <table class="table table-striped table-nowrap">
                ...
                <tr>
                    ...
                    <td><?php echo htmlentities($account['frontend_remark']); ?></td>
                        <td><?php echo !empty($account['enable']) ? "cho phép"  :  "Tử chối"; ?></td>
                    ...
                    <td>
                        <?php if(env('backend.enable_api')): ?>
                            <a class="btn btn-yellow" href="/user/account/<?php echo htmlentities($account['id']); ?>/restart">Khởi động lại nhiệm vụ</a>
                        <?php endif; ?>
                        <a class="btn btn-secondary" href="/user/account/<?php echo htmlentities($account['id']); ?>">Sửa</a>
