<?php /*a:2:{s:50:"/www/wwwroot/autoapple.shop/view/share/result.html";i:1691722288;s:44:"/www/wwwroot/autoapple.shop/view/layout.html";i:1683542048;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
                ...
                <div class="card shadow-lg" style="margin-top: 1rem;">
                    ...
                    <div class="card-body">
                        ...
                        <?php if($account->min_manual_unlock!=0 && env('backend.enable_api')): ?>
                                <a href="/share/<?php echo htmlentities($link); ?>/<?php echo htmlentities($account->id); ?>/unlock" class="btn btn-warning">mở khóa thủ công</a>
                        <?php endif; ?>
                    </div>
                </div>
            <?php if(count($accounts) > 1): ?>
