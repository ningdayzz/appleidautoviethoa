<?php /*a:4:{s:55:"/www/wwwroot/autoapple.shop/view/admin/shareDetail.html";i:1688836102;s:44:"/www/wwwroot/autoapple.shop/view/layout.html";i:1683542048;s:50:"/www/wwwroot/autoapple.shop/view/admin/header.html";i:1688834624;s:49:"/www/wwwroot/autoapple.shop/view/user/footer.html";i:1688813568;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="card border">
    <h2 class="card-header bg-primary text-white text-center">Chỉnh sửa trang chia sẻ</h2>
    <form action="" method="post" style="margin: 20px;">
        ...
        <div class="input-group mb-3">
            ...
            <input type="number" class="form-control" required name="owner" value="<?php echo htmlentities($share->owner); ?>">
        </div>
        <div class="alert alert-info" role="alert">
            <div class="d-flex">
                ...
                <div>
                    <div class="text-muted">Để trống thời gian hết hạn có nghĩa là không bao giờ hết hạn</div>
                </div>
            </div>
        </div>
