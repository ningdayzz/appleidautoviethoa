<?php /*a:4:{s:57:"/www/wwwroot/apple.zenpn.com/view/user/accountDetail.html";i:1688815153;s:45:"/www/wwwroot/apple.zenpn.com/view/layout.html";i:1683542048;s:50:"/www/wwwroot/apple.zenpn.com/view/user/header.html";i:1688815274;s:50:"/www/wwwroot/apple.zenpn.com/view/user/footer.html";i:1688813568;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="card border">
    <h2 class="card-header bg-primary text-white text-center"><?php echo $action=="add" ? "Thêm tài khoản" : "Chỉnh sửa tài khoản"; ?></h2>
    <form action="" method="post" style="margin: 20px;">
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="input-group mb-3">
                    <span class="input-group-text" id="answer2">Câu trả lời 3</span>
        ...
        <div class="input-group mb-3">
            ...
            <input type="number" class="form-control" name="check_interval" required autocomplete="off"
                   placeholder="单位：分钟" value="<?php echo htmlentities($account->check_interval); ?>">
        </div>
        <?php if($action=="edit"): ?>
            <div class="input-group mb-3">
