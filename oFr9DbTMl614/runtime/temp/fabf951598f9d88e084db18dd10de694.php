<?php /*a:4:{s:50:"/www/wwwroot/apple.zenpn.com/view/admin/share.html";i:1688835730;s:45:"/www/wwwroot/apple.zenpn.com/view/layout.html";i:1683542048;s:51:"/www/wwwroot/apple.zenpn.com/view/admin/header.html";i:1688834624;s:50:"/www/wwwroot/apple.zenpn.com/view/user/footer.html";i:1688813568;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-striped table-nowrap">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-secondary" href="/admin/share/<?php echo htmlentities($share['id']); ?>">Biên tập</a>
...
<script>
    ...
    deleteButtons.forEach(function (button) {
        button.addEventListener('click', function () {
            ...
            // 显示SweetAlert2确认弹窗
            Swal.fire({
                title: 'Bạn có chắc chắn muốn xóa trang chia sẻ này không?',
                icon: 'warning',
